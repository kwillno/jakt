...
@cli.command()
@click.option('-t', '--to', 'to', type=click.DateTime(formats=['%d-%m-%Y %H:%M:%S', '%H:%M:%S']), help="Starttime of search period")
@click.option('-f', '--from', 'from_', type=click.DateTime(formats=['%d-%m-%Y %H:%M:%S', '%H:%M:%S']), help="Endtime of search period")
@click.option('-c', '--categories', is_flag=True, default=False, help="Display categories")
